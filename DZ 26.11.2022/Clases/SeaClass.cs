...
{
    class SeaClass:InterfaceGame
    {
        public void PlayGame(List<string> teams, List<string> games)
        {
            Console.WriteLine("Игра в которой предстоит сразится четырём командам :" + games[2]);
            Thread.Sleep(2000);
            ...
            Console.WriteLine("Игра под названием " + games[2] + " началась");
