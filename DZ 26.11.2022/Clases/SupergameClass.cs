...
{
    internal class SupergameClass:InterfaceGame
    {
        public void PlayGame(List<string> teams, List<string> games)
        {
            Console.WriteLine("Игра в которой предстоит сразится четырём командам :" + games[6]);
            Thread.Sleep(2000);
            ...
            Console.WriteLine("Игра под названием " + games[6] + " началась");
